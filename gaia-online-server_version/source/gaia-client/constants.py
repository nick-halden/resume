...
BROWN = 'brown'
GAIA = 'gaia'
GAIAFORMED = 'gaiaformed'  # Gaia planet with gaiaformer on it?
ORANGE = 'orange'
RED = 'red'
TRANSDIM = 'transdim'
...
NOT_ENOUGH_POWERSTONES = 'not enough pws'
...
NEED_CHOOSE_FED = 'Wähle einen Allianzmarker aus,\n den du nochmal werten möchtest'
